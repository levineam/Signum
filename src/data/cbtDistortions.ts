...
export const CBT_DISTORTIONS: CbtDistortion[] = [
  {
    ...
    insertionText: 'Today I fell into All-or-Nothing thinking. Here\'s what happened:'
  },
  {
    ...
    insertionText: 'Today I overgeneralized. Here\'s what happened:'
  },
  {
    id: 'mental-filter',
    name: 'Mental Filter',
    ...
    insertionText: 'Today I filtered out the positive and focused only on the negative. Here\'s what happened:'
  },
  {
    ...
    insertionText: 'Today I discounted a positive experience. Here\'s what happened:'
  },
  {
    ...
    insertionText: 'Today I jumped to a conclusion. Here\'s what happened:'
  },
  {
    ...
    insertionText: 'Today I blew something out of proportion. Here\'s what happened:'
  },
  {
    ...
    insertionText: 'Today I let my feelings control my thinking. Here\'s what happened:'
  },
  {
    ...
    insertionText: 'Today I got caught up in \'should\' thinking. Here\'s what happened:'
  },
  {
    id: 'labeling',
    name: 'Labeling',
    ...
    insertionText: 'Today I labeled myself (or someone else) harshly. Here\'s what happened:'
  },
  {
    ...
    insertionText: 'Today I personalized something that wasn\'t about me. Here\'s what happened:'
  }
]
 ...
 * Uses natural, conversational language specific to each distortion
 */
export function formatDistortionReflection(distortion: CbtDistortion): string {
  return `<p>${distortion.insertionText} </p><p><br></p>`
}
