        ...
        <div className="flex items-center justify-between gap-2 text-xs font-semibold uppercase tracking-[0.08em] text-slate-500">
          ...
          <div className="flex items-center gap-2">
            <Input
              ...
              className="flex-1"
            />
            <Button size="icon" onClick={handleAddGoal} disabled={savingExecution} aria-label="Add goal">
                        ...
                        <div
                          ...
                          onKeyDown={(e) => {
                            if (e.key === 'Enter' || e.key === ' ') {
                              e.preventDefault()
                              startEditItem('goals', goal)
                            }
                          }}
                          aria-label={`Click to edit ${goal.name}`}
                        >
                          {goal.name}
                        </div>
                        <div className="flex items-center gap-2">
                                ...
                                <div className="space-y-1 flex-1">
                                  <p
                                    ...
                                    onKeyDown={(e) => {
                                      if (e.key === 'Enter' || e.key === ' ') {
                                        e.preventDefault()
                                        startEditItem('projects', project)
                                      }
                                    }}
                                          ...
                                          <div className="space-y-1 flex-1">
                                            <p
                                              ...
                                              onKeyDown={(e) => {
                                                if (e.key === 'Enter' || e.key === ' ') {
                                                  e.preventDefault()
                                                  startEditItem('tasks', task)
                                                }
                                              }}
                                              aria-label={`Click to edit ${task.name}`}
                                            >
                                              {task.name}
                                            </p>
                                          </div>
